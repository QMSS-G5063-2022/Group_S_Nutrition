...
```{r, message = FALSE, warning = FALSE}
life_cancer2018 <- food_life %>%
  arrange(., iso3)%>%
  filter(varnum==1,year==2018)%>%
...
life_plot <- leaflet(life_sp,
 ...
 # add legend 
  addLegend("bottomright", 
    pal = colorNumeric("Blues", life_sp$life_exp), 
            values = ~life_exp,
    title = htmltools::HTML("Life Expentancy 2018"),
    opacity = 1)
 

frameWidget(life_plot)

...
Here we generate a word cloud from tweets which is under the tag "nutritional", and we would like to see whether those text refer to specfic types of food that we can pay more attention to later.
...
```
It turns out that there are some words related to vegetables and most of the words are positive. Vegetables may be a potential focus for our later research.
